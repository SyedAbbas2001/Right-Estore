    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-purple-50 to-white">
      <div className="text-center">
        <div className="relative mb-8">
          ...
          <div className="absolute -top-2 -right-6 text-3xl animate-float" style={{animationDelay: '0.3s'}}>⭐</div>
          <div className="absolute -bottom-2 -left-6 text-2xl animate-float" style={{animationDelay: '0.6s'}}>✨</div>
        </div>
        ...
        <p className="text-gray-400 font-semibold text-sm mt-2">Preparing something wonderful ✨</p>
      </div>
    </div>
  );
}
